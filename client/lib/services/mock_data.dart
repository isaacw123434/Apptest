...
final Map<String, dynamic> routesMap = {
  ...
  'bus': 'bus_leeds',
  'cycle': 'cycle_leeds',
  'train_walk_headingley': 'train_headingley',
...
final Map<String, dynamic> segmentOptionsData = {
  'firstMile': [
    ...
    },
    {
      ...
      'nextBusIn': 12,
      'segments': [
        { 'mode': 'bus', 'label': 'Bus', 'lineColor': '#30227d', 'iconId': IconIds.bus, 'time': 23, 'to': 'Leeds Station', 'distance': 3.14, 'co2': 0.41 }
      ]
    },
    {
      'id': 'drive_park',
      ...
      'desc': 'Flexibility.',
      'segments': [
        { 'mode': 'car', 'label': 'Drive', 'lineColor': '#3f3f46', 'iconId': IconIds.car, 'time': 15, 'to': 'Leeds Station', 'distance': 4.20, 'co2': 0.88 }
      ]
    },
    {
      ...
      'segments': [
        { 'mode': 'walk', 'label': 'Walk', 'lineColor': '#475569', 'iconId': IconIds.footprints, 'time': 18, 'to': 'Headingley Station', 'distance': 0.82, 'co2': 0.0 },
        { 'mode': 'train', 'label': 'Northern', 'lineColor': '#262262', 'iconId': IconIds.train, 'time': 10, 'to': 'Leeds Station', 'distance': 3.2, 'co2': 0.18 }
      ]
    },
    {
      ...
      'waitTime': 3,
      'segments': [
        { 'mode': 'taxi', 'label': 'Uber', 'lineColor': '#000000', 'iconId': IconIds.car, 'time': 5, 'to': 'Headingley Station', 'distance': 1.2, 'co2': 0.33 },
        { 'mode': 'train', 'label': 'Northern', 'lineColor': '#262262', 'iconId': IconIds.train, 'time': 10, 'to': 'Leeds Station', 'distance': 3.2, 'co2': 0.18 }
      ]
    },
    {
      ...
      'desc': 'Zero emissions.',
      'segments': [
        { 'mode': 'bike', 'label': 'Bike', 'lineColor': '#00FF00', 'iconId': IconIds.bike, 'time': 17, 'to': 'Leeds Station', 'distance': 3.20, 'co2': 0.0 }
      ]
    }
  ],
  'mainLeg': {
    ...
    'detail': 'Leeds → Loughborough (1 change)',
    'time': 102,
    'cost': 25.70,
    'distance': 90.89,
    'co2': 5.11,
  ...
  'lastMile': [
    {
      ...
      'segments': [
        { 'mode': 'taxi', 'label': 'Uber', 'lineColor': '#000000', 'iconId': IconIds.car, 'time': 10, 'to': 'East Leake', 'distance': 4.50, 'co2': 1.22 }
      ]
    },
    {
      'id': 'bus',
      ...
      'segments': [
        { 'mode': 'bus', 'label': 'Bus', 'lineColor': '#002663', 'iconId': IconIds.bus, 'time': 14, 'to': 'East Leake', 'distance': 4.03, 'co2': 0.66 }
      ]
    },
    {
      'id': 'cycle',
      ...
      'desc': 'Scenic route.',
      'segments': [
        { 'mode': 'bike', 'label': 'Bike', 'lineColor': '#00FF00', 'iconId': IconIds.bike, 'time': 24, 'to': 'East Leake', 'distance': 4.50, 'co2': 0.0 }
      ]
    }
  ]
};
