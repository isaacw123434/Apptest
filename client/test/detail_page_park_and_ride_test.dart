...
void main() {
  testWidgets('DetailPage handles Park and Ride correctly (no parking split)', (
    WidgetTester tester,
  ) async {
    ...
    double totalCost =
        4.5; // distance * 0.45, so usually would show free parking
  ...
  testWidgets('DetailPage allows editing P&R bus segment', (
    WidgetTester tester,
  ) async {
    tester.view.physicalSize = const Size(1080, 2400);
    tester.view.devicePixelRatio = 1.0;
