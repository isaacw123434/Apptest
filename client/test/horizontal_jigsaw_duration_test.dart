...
void main() {
  testWidgets('HorizontalJigsawSchematic displays duration text', (
    WidgetTester tester,
  ) async {
    final segments = [
      Segment(
    ...
    // Second segment
    final col2 = find.descendant(
      of: find.byWidget(segmentsWidgets[1]),
      matching: find.byType(Column),
    );
    expect(col2, findsOneWidget);
    expect(
      find.descendant(of: col2, matching: find.text('1h 5m')),
      findsOneWidget,
    );
