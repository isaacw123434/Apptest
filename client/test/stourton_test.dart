...
class StourtonMockApiService extends ApiService {
  ...
  Future<InitData> fetchInitData({String? routeId}) async {
    ...
    final stourtonLeg = Leg(
        ...
        lineColor: '#262262',
        segments: [
             Segment(mode: 'car', label: 'Drive', lineColor: '#0000FF', iconId: 'car', time: 64, to: 'Stourton Park & Ride'),
             Segment(mode: 'walk', label: 'Walk', lineColor: '#000000', iconId: 'footprints', time: 3, to: 'Stourton Park and Ride'),
             Segment(mode: 'bus', label: 'PR3 Park & Ride', lineColor: '#000000', iconId: 'bus', time: 10, from: 'Stourton Park and Ride', to: 'Trinity K'),
             Segment(mode: 'walk', label: 'Walk', lineColor: '#000000', iconId: 'footprints', time: 10, to: 'Dest'),
        ],
    );
    ...
    final templeGreenLeg = Leg(
        ...
        lineColor: '#e0603a',
        segments: [
             Segment(mode: 'car', label: 'Drive', lineColor: '#0000FF', iconId: 'car', time: 66, to: 'Temple Green Park & Ride'),
             Segment(mode: 'bus', label: 'PR2 Park & Ride', lineColor: '#e0603a', iconId: 'bus', time: 15, from: 'Temple Green Park and Ride', to: 'Cultural C'),
        ],
    );
    ...
    final broughLeg = Leg(
        ...
        lineColor: '#262262',
        segments: [
             Segment(mode: 'car', label: 'Drive', lineColor: '#0000FF', iconId: 'car', time: 26, to: 'Brough Station'),
             Segment(mode: 'wait', label: 'Transfer', lineColor: '#000000', iconId: 'clock', time: 10),
             Segment(mode: 'train', label: 'Northern', lineColor: '#262262', iconId: 'train', time: 63, from: 'Brough Station', to: 'Leeds Station'),
        ],
    );
...
void main() {
  testWidgets('Stourton P&R Edit shows all options', (WidgetTester tester) async {
    ...
    final dummyResult = JourneyResult(
      id: 'dummy',
      leg1: stourtonLeg,
      leg3: Leg(id: 'empty', label: '', time: 0, cost: 0, distance: 0, riskScore: 0, iconId: '', lineColor: '', segments: []),
