...
void main() {
  testWidgets(
    'DetailPage shows "Free, but limited parking" when parking cost is 0',
    (WidgetTester tester) async {
      ...
      expect(
        find.text('Parking cost: Free, but limited parking'),
        findsOneWidget,
      );
  ...
  testWidgets('DetailPage shows parking cost when > 0', (
    WidgetTester tester,
  ) async {
    tester.view.physicalSize = const Size(1080, 2400);
    tester.view.devicePixelRatio = 1.0;
